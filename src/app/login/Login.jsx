      ...
      <div className="flex justify-center">
        <div className="h-[90%] w-full md:w-3/4 m-4">
          <div className="text-xl cursor-pointer flex flex-col justify-center items-center mt-5 md:mt-0">
            ...
            <div className="flex">
              <i
                className="py-2 rounded fa fa-facebook px-4 border-2 m-1 cursor-pointer border-violet-600 text-black bg-violet-600 hover:bg-white hover:text-violet-600 text-2xl"
              ></i>
              <i
                className="py-2 fa fa-google rounded px-4 border-2 m-1 cursor-pointer border-blue-500 bg-blue-500 text-black hover:bg-white hover:text-blue-500 text-2xl"
              ></i>
            </div>
